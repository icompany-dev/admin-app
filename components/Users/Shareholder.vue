<template>
  ...
  >
    ...
    <div class="human-detail">
      <i class="fa-regular fa-chart-pie" />
      <span class="human-detail-content">
        <b>{{ controller.ordinarySharesLabel }}</b>
        : {{ NumberUtil.thousandSeparator(controller.shareholder.value.ordinaryShares) }} /
        <b>{{ controller.preferenceSharesLabel }}</b>
        : {{ NumberUtil.thousandSeparator(controller.shareholder.value.preferenceShares) }}
      </span>
    </div>
  </div>
</template>
...
<script lang="ts" setup>
  ...
  import { ShareholderController } from "~/scripts/components/users/ShareholderController"
...
<style lang="scss">
  ...
  @use "~/assets/scss/components/Users/Shareholder" as *;
</style>
