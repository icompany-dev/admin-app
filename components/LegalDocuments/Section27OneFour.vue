<template>
  <div
    ...
    ref="documentRef"
  >
    <template v-if="controller.isShowPdfFile">
      <div>
        <canvas
          v-for="(page, i) in controller.pdfPaperRanges"
          :ref="(el) => controller.setCanvasRefs(el, i)"
        />
      </div>
    </template>
    <template v-if="!controller.isShowPdfFile">
        ...
        <template #paperContent>
          ...
          <div class="document-section">
            <table>
              <thead>
                <tr>
                  <td colspan="2">PARTICULARS OF APPLICATION</td>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td>Proposed Company Name</td>
                  <td>{{ controller.proposedName() }}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>N - NEW INCORPORATION</td>
                </tr>
                <tr>
                  <td>Company Type</td>
                  <td>S - LIMITED BY SHARES</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div class="document-section">
            <table>
              <thead>
                <tr>
                  <td colspan="2">PARTICULARS OF APPLICANT</td>
                </tr>
              </thead>
              <tbody>
                <tr>
          ...
          <div class="document-section">
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    5) If the proposed name is a trademark, state whether consent has been obtained from the owner
                    (please attach consent).
                  </td>
                  <td>NIL</td>
                </tr>
                <tr>
        ...
        <template #paperContent>
          <div class="document-section">
            <table>
              ...
              <tbody>
                ...
                <tr class="promoter">
                  <td>
                    {{ controller.applicant.value.name }}
                  </td>
                  <td>
                    {{ controller.promoterIdentificationType() }}
                  </td>
                  <td>
                    {{ controller.applicant.value.detail?.identification }}
                  </td>
                  <td>
                    {{ controller.dateOfBirth() }}
                  </td>
                  <td>
                    {{ controller.applicant.value.email }}
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div class="document-section">
            <table>
              <thead>
                <tr>
                  <td colspan="1">DECLARATION SECTION</td>
                </tr>
              </thead>
              <tbody>
                <tr class="declaration">
                  <td>
                    ...
                    <p>
                      ...
                      statement that a person knows is false or misleading and that person may be liable, upon
                      conviction, to imprisonment for a term not exceeding ten years or to a fine not exceeding RM3
                      million or to both.
                    </p>
                  </td>
                </tr>
          ...
          <div class="document-section">
            <table>
              <thead>
                <tr>
                  <td colspan="2">LODGER INFORMATION</td>
                </tr>
              </thead>
              <tbody>
                <tr>
                ...
                <tr>
                  <td>Prescribed Body Type</td>
                  <td>Licensed Secretary (LS)</td>
                </tr>
                <tr>
