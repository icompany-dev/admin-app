          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>C - CHANGE OF COMPANY NAME</td>
              </tr>
              <tr>
                <td>Company Type</td>
        ...
        <div class="document-section">
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td>
                  5) If the proposed name is a trademark, state whether consent has been obtained from the owner (please
                  attach consent).
                </td>
                <td>NIL</td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  {{ controller.changeOfName.value.company?.businessDescription }}
                </td>
              </tr>
              <tr>
...
<script setup lang="ts">
  ...
  import { Section27ForCompanyController } from "~/scripts/components/legal-documents/Section27ForCompanyController"
  ...
  const controller = new Section27ForCompanyController(props.applicationId, props.changeOfName)
