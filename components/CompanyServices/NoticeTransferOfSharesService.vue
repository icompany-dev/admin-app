<template>
  <div
    id="company-service-notice-transfer-shares"
...
<script setup lang="ts">
  ...
  import { NoticeTransferOfSharesServiceController } from "~/scripts/components/company-services/NoticeTransferOfSharesServiceController"
  ...
  const controller = new NoticeTransferOfSharesServiceController(props.companyId, props.viewType, emit)
