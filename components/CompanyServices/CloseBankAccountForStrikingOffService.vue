...
<script lang="ts" setup>
  ...
  import { CloseBankAccountForStrikingOffServiceController } from "~/scripts/components/company-services/CloseBankAccountForStrikingOffServiceController"
  ...
  const controller = new CloseBankAccountForStrikingOffServiceController(
    props.companyId,
    props.companyBankId,
    props.viewType,
    emit
