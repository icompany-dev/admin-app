...
<script setup lang="ts">
  ...
  import { SetFinancialYearEndServiceController } from "~/scripts/components/company-services/SetFinancialYearEndServiceController"
  ...
  const controller = new SetFinancialYearEndServiceController(
    props.companyId,
    props.viewType,
