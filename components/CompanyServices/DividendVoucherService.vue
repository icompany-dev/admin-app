...
<script setup lang="ts">
  ...
  import { DividendVoucherServiceController } from "~/scripts/components/company-services/DividendVoucherServiceController"
  ...
  const controller = new DividendVoucherServiceController(props.companyId, emit)
