...
<script setup lang="ts">
  ...
  import { AdoptConstitutionServiceController } from "~/scripts/components/company-services/AdoptConstitutionServiceController"
  ...
  const controller = new AdoptConstitutionServiceController(props.companyId, props.viewType, emit)
