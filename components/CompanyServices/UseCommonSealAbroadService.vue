...
<script setup lang="ts">
  ...
  import DcrOfficialSeal from "../Resolutions/DcrOfficialSeal.vue"
  import Tooltip from "../Tooltips/Tooltip.vue"
  import { UseCommonSealAbroadServiceController } from "~/scripts/components/company-services/UseCommonSealAbroadServiceController"
  ...
  const controller = new UseCommonSealAbroadServiceController(props.companyId, props.viewType, emit)
