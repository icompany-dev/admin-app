...
<script setup lang="ts">
  ...
  import { ProposeAdoptConstitutionServiceController } from "~/scripts/components/company-services/ProposeAdoptConstitutionServiceController"
  ...
  const controller = new ProposeAdoptConstitutionServiceController(props.companyId, props.viewType, emit)
