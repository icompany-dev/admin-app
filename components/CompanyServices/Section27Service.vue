...
<script setup lang="ts">
  ...
  import { Section27ServiceController } from "~/scripts/components/company-services/Section27ServiceController"
  ...
  const controller = new Section27ServiceController(props.companyId, props.viewType, props.applicationId, emit)
