...
<script setup lang="ts">
  ...
  import { AuditExtensionOfTimeServiceController } from "~/scripts/components/company-services/AuditExtensionOfTimeServiceController"
  ...
  const controller = new AuditExtensionOfTimeServiceController(props.companyId, props.viewType, emit)
