    ...
    >
      <template #resolutions>
        <TransitionGroup
          ...
          tag="div"
          class="documents"
          :class="{ invert: controller.isByShareholder.value }"
        >
          ...
          <McrAppointmentOfDirector
            ref="mcrRef"
            v-if="controller.isByShareholder.value"
            v-bind="controller.resolutionDocumentProps"
            @total-page-changed="controller.handleDoneLoading()"
          />
        </TransitionGroup>
...
<script setup lang="ts">
  ...
  import { AppointNewDirectorServiceController } from "~/scripts/components/company-services/AppointNewDirectorServiceController"
  ...
  const controller = new AppointNewDirectorServiceController(
    props.companyId,
    props.viewType,
...
<style lang="scss">
  ...
  @use "~/assets/scss/components/CompanyServices/AppointNewDirector" as *;
</style>
