...
<script setup lang="ts">
  ...
  import { AppointResponsiblePersonForFinancialStatementServiceController } from "~/scripts/components/company-services/AppointResponsiblePersonForFinancialStatementServiceController"
  ...
  const controller = new AppointResponsiblePersonForFinancialStatementServiceController(
    props.companyId,
