<template>
  <div id="company-services-notify-bank-change-of-company-name-service">
    <div
      ...
      <template #resolutions>
        ...
        >
          <NotifyBankChangeOfCompanyName
            ...
            :previousName="''"
            :applicationId="controller.companyNotifyChangeOfName.value.id"
            :isInPreviewMode="controller.isInPreviewMode.value"
            :showWatermark="controller.showWatermark()"
            :watermarkText="controller.watermarkText()"
            :isShowTags="false"
...
<script lang="ts" setup>
  ...
  import { NotifyBankChangeOfCompanyNameServiceController } from "~/scripts/components/company-services/NotifyBankChangeOfCompanyNameServiceController"
  ...
  const controller = new NotifyBankChangeOfCompanyNameServiceController(props.companyId, props.viewType, emit)
...
<style lang="scss">
  @use "~/assets/scss/components/CompanyServices/NotifyBankChangeOfCompanyNameService" as *;
</style>
