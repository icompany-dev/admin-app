...
<script setup lang="ts">
  ...
  import { AppointAuditorForSubmissionServiceController } from "~/scripts/components/company-services/AppointAuditorForSubmissionServiceController"
  ...
  const controller = new AppointAuditorForSubmissionServiceController(props.companyId, props.viewType, emit)
