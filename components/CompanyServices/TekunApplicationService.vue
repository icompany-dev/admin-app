...
<script lang="ts" setup>
  ...
  import { TekunApplicationServiceController } from "~/scripts/components/company-services/TekunApplicationServiceController"
  ...
  const controller = new TekunApplicationServiceController(props.companyId, props.viewType, emit)
