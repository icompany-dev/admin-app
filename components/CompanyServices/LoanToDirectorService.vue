<template>
  <div
    id="company-service-loan-to-director"
...
<script setup lang="ts">
  ...
  import { LoanToDirectorServiceController } from "~/scripts/components/company-services/LoanToDirectorServiceController"
  ...
  const controller = new LoanToDirectorServiceController(props.companyId, props.viewType, emit)
