...
<script lang="ts" setup>
  ...
  import DcrAppointChairman from "../Resolutions/DcrAppointChairman.vue"
  import CompanyServiceWrapper from "@/components/CompanyServices/CompanyServiceWrapper.vue"
  import LoaderPrepare from "@/components/Loaders/Prepare.vue"
  import { AppointChairmanServiceController } from "~/scripts/components/company-services/AppointChairmanServiceController"
  ...
  const controller = new AppointChairmanServiceController(props.companyId, props.viewType, emit)
