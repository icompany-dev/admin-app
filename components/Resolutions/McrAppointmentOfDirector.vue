...
<script setup lang="ts">
  ...
  import { McrAppointmentOfDirectorController } from "~/scripts/components/resolutions/McrAppointmentOfDirectorController"
  import type { IPropsResolutionDocument } from "~/scripts/props/PropsResolutionDocument"
  import type { CompanyDirectorAppointment } from "~/scripts/models/CompanyDirectorAppointment"
  ...
  const controller = new McrAppointmentOfDirectorController(props, emit)
