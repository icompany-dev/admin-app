<template>
  <div
    id="dcr-bank-account-opening-affin-bank"
    ref="documentRef"
  >
    <Paper
            ...
            <ol class="upper-alpha">
              ...
              <li>
                ...
                <ol class="lower-roman">
                  ...
                  <li v-if="controller.showSignatoriesOnFirstPage">
                    ...
                    <ol class="number margin-top">
                      <li>
                        ...
                        <div class="form-group margin-top has-textarea">
          ...
          <div class="resolution-content">
            ...
            >
              <li class="no-number">
                <ol
                  class="lower-roman"
                  :class="controller.showSignatoriesOnFirstPage ? 'no-number' : ''"
                  start="3"
                >
                  <li>
                    <template v-if="!controller.showSignatoriesOnFirstPage">
                      Provided they be signed by
                      <span
                        class="prefilled-input-field wide"
                        v-if="controller.isDocumentEditable()"
                    ...
                    <ol
                      class="number margin-top"
                      :start="controller.showSignatoriesOnFirstPage ? 2 : 1"
                    >
                      <li v-if="!controller.showSignatoriesOnFirstPage">
                        Authorized Signatories for Current Account:
                        <ol class="lower-alpha-bracket margin-top">
              ...
              <li v-if="controller.isAdministratorDetailsOnPage2">
                ...
                <span
                  class="optional blue"
                  v-if="controller.affinBankApplicationDetails.value.isAllowLinkAndTransactSubsidiary"
                >
              ...
              <template v-if="controller.showOtherConditionsOnPage2">
                <li>
                  “THAT any termination, cessation, dismissal, retirement, resignation, contract expiry, or death of
                  above authorised personnel will be informed by the Company to the Bank officially with the submission
                  of Maintenance form. In the event of the replacement of any of the System Administrator and/or System
                  Approver, the Company hereby authorises the Authorised Signatories to appoint such replacement
                  personnel from time to time and such replacement personnel shall be authorised to act as the System
                  Administrator (for creation of Company users of the Corporate Internet Banking services) and/or the
                  System Approver (for the approval of the creation of Company users of the Corporate Internet Banking
                ...
                <li>
                  ...
                  The Authorised Signatories of the Company is authorised to accept the Terms and Conditions; for
                  purposes of obtaining the transactional services under the Corporate Internet Banking services applied
                  for by the Company and made available by the Bank from time to time. The Company hereby appoints the
                  Authorised Signatories herein to accept the Terms and Conditions of Corporate Internet Banking
                  services, if need be and to deal with and liaise with the Bank on all matters in relation thereto. The
                  details and specimen signature(s) of the Authorised Signatories are set forth below.”
                </li>
                <li>
                  “THAT a certified true copy of this resolution is to be furnished to the Bank and this resolution
                  shall remain in force until notice in writing to the contrary is given to the Bank by the Company
                  which notice has to be duly acknowledged in writing by the Bank.”
                </li>
                <li v-if="controller.isDocumentEditable()">
                  <div class="form-check">
                    <input
                    ...
                    >
                      “The term "Company" wherever appearing herein shall include and mean any transaction(s) in
                      Corporate Internet Banking services conducted by the Company for itself or on behalf of by any of
                      its Subsidiaries. The Company shall notify the Bank of any changes in its
                      Subsidiaries/Subsidiaries Account(s).” (
                      <span class="note">**APPLICABLE ONLY TO LINK SUBSIDIARY ACCOUNT</span>
                      )
                    </span>
                  </div>
      ...
      >
        <template #paperContent>
          ...
          <div class="resolution-content">
            <ol
              class="upper-alpha"
              v-if="!controller.showOtherConditionsOnPage2"
