<template>
  <div id="dcr-bank-account-opening-current">
    <Resolution
...
<script lang="ts" setup>
  ...
  import { DcrBankAccountOpeningCurrentController } from "~/scripts/components/resolutions/DcrBankAccountOpeningCurrentController"
  ...
  const controller = new DcrBankAccountOpeningCurrentController(props, emit)
...
<style lang="scss">
  @use "~/assets/scss/components/Resolutions/DcrBankAccountOpeningCurrent" as *;
</style>
