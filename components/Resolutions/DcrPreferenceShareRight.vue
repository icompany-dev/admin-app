<template>
  <div id="dcr-preference-share-right">
    <Resolution
...
<script setup lang="ts">
  ...
  import { DcrPreferenceShareRightController } from "~/scripts/components/resolutions/DcrPreferenceShareRightController"
  ...
  const controller = new DcrPreferenceShareRightController(props, emit)
