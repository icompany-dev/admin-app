...
<script setup lang="ts">
  ...
  import { DcrAbolishmentOfConstitutionController } from "~/scripts/components/resolutions/DcrAbolishmentOfConstitutionController"
  ...
  const controller = new DcrAbolishmentOfConstitutionController(props, emit)
