...
<script setup lang="ts">
  ...
  import { McrAmendmentOfConstitutionController } from "~/scripts/components/resolutions/McrAmendmentOfConstitutionController"
  ...
  const controller = new McrAmendmentOfConstitutionController(props, emit)
