...
<script lang="ts" setup>
  ...
  import TekunLoanApplication from "../Services/TekunLoanApplication.vue"
  import TekunApplicationService from "../CompanyServices/TekunApplicationService.vue"
  import { TekunApplicationController } from "~/scripts/components/secretarial-services/TekunApplicationController"
  ...
  const controller = new TekunApplicationController(props, emit)

  const componentMap: Record<string, any> = {
    [DocumentTargets.TARGET_LOAN_APPLICATION_RESOLUTIONS]: TekunApplicationService,
...
<style lang="scss">
  ...
  @use "~/assets/scss/components/SecretarialServices/TekunApplication" as *;
</style>
