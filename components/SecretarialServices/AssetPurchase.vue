...
<script lang="ts" setup>
  import PurchaseAssetApplication from "../Services/PurchaseAssetApplication.vue"
  import ReceiptInvoiceService from "../CompanyServices/ReceiptInvoiceService.vue"
  import PurchaseAssetService from "../CompanyServices/PurchaseAssetService.vue"
  import { AssetPurchaseController } from "~/scripts/components/secretarial-services/AssetPurchaseController"
  ...
  const controller = new AssetPurchaseController(props, emit)

  const componentMap: Record<string, any> = {
    [DocumentTargets.TARGET_PURCHASE_ASSET_RESOLUTIONS]: PurchaseAssetService,
...
<style lang="scss">
  ...
  @use "~/assets/scss/components/SecretarialServices/AssetPurchase" as *;
</style>
