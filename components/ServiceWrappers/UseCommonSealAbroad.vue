...
<script setup lang="ts">
  ...
  import { UseCommonSealAbroadController } from "~/scripts/components/service-wrappers/UseCommonSealAbroadController"
  ...
  const controller = new UseCommonSealAbroadController(props.companyId, emit, props.applicationId)
