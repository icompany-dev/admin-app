<template>
  <div
    id="service-wrappers-section201-for-director"
...
<script lang="ts" setup>
  import { Section201ForDirectorController } from "~/scripts/components/service-wrappers/Section201ForDirectorController"
  ...
  const controller = new Section201ForDirectorController(props.applicationId, emit)
...
<style lang="scss">
  ...
  @use "~/assets/scss/components/ServiceWrappers/Section201ForDirector" as *;
</style>
