...
<script lang="ts" setup>
  ...
  import { AppointChairmanController } from "~/scripts/components/service-wrappers/AppointChairmanController"
  ...
  const controller = new AppointChairmanController(props.companyId, emit, props.applicationId)
