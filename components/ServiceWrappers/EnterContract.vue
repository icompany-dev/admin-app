...
<script lang="ts" setup>
  ...
  import { EnterContractController } from "~/scripts/components/service-wrappers/EnterContractController"
  ...
  const controller = new EnterContractController(props.companyId, emit, props.applicationId)
