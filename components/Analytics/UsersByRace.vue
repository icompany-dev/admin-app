...
<script lang="ts" setup>
  ...
  import { UsersByRaceController } from "~/scripts/components/analytics/UsersByRaceController"
  ...
  const controller = new UsersByRaceController(props, emit)
...
<style lang="scss">
  @use "~/assets/scss/components/Analytics/UsersByRace" as *;
</style>
