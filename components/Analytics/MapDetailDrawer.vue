      ...
      >
        <div class="company-items-container">
          <div class="company-item">
            <div class="item-title">Registration No.</div>
            <span>{{ controller.selectedCompany.value?.regNo }}</span>
          </div>
          <div class="company-item">
            <div class="item-title">Total Shares</div>
            <span>{{ controller.selectedCompany.value?.paidUpCapital }}</span>
          </div>
          <div class="company-item">
            <div class="item-title">Est. Year</div>
            <span>{{ controller.selectedCompany.value?.establishedYear }}</span>
          </div>
          <div class="company-item">
            <div class="item-title">Composition</div>
            <span>
              <b>Director</b>
              {{ controller.selectedCompany.value?.directorsCount }}
              <br />
              <b>Shareholder</b>
              {{ controller.selectedCompany.value?.shareholdersCount }}
            </span>
          </div>
        </div>
