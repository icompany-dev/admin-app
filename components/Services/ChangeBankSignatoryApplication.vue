<template>
  <div id="services-change-bank-signatory-application">
    <ServiceApplication
...
<script lang="ts" setup>
  ...
  import { ChangeBankSignatoryApplicationController } from "~/scripts/components/services/ChangeBankSignatoryApplicationController"
  ...
  const controller = new ChangeBankSignatoryApplicationController(props, emit)
...
<style lang="scss">
  @use "~/assets/scss/components/Services/ChangeBankSignatoryApplication" as *;
</style>
