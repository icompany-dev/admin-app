<template>
  <div id="services-dividend-declaration-application">
    <ServiceApplication
...
<script lang="ts" setup>
  ...
  import { DividendDeclarationApplicationController } from "~/scripts/components/services/DividendDeclarationApplicationController"
  ...
  const controller = new DividendDeclarationApplicationController(props, emit)
...
<style lang="scss">
  @use "~/assets/scss/components/Services/DividendDeclarationApplication" as *;
</style>
