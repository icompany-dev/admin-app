...
export class PageAllDirectorsController extends PageController {
  ...
  constructor() {
    let title: string = "All Directors - iCompany Malaysia"
    let description: string = "All Directors of Sdn Bhd"

    super(title, description, "All Directors")
  }
  ...
  get breadCrumbProps(): PropsBreadCrumb {
    return new PropsBreadCrumb([new PropsBreadCrumbItem("Companies", ""), new PropsBreadCrumbItem("Directors", "")])
  }
