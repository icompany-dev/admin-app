...
export class CompanyNameFilterRepository extends Repository<CompanyNameFilter> {
  constructor(
    resourceUrl: string,
    ...
    super(resourceUrl, singleResourceUrl, baseUrl, getAuthToken, CompanyNameFilter)
  }
