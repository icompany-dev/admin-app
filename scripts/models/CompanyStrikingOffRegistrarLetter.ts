...
export class CompanyStrikingOffRegistrarLetter extends Application {
  ...
  constructor(data: any | null = null) {
    ...
    if (data instanceof CompanyStrikingOffRegistrarLetter) {
  ...
  cloneDetails(data: CompanyStrikingOffRegistrarLetter): void {
    super.clone(data)
  ...
  async create(repository: ReturnType<typeof useCompanyStrikingOffRegistrarLetterStore>): Promise<void> {
    if (!this.canSubmit()) {
  ...
  async update(repository: ReturnType<typeof useCompanyStrikingOffRegistrarLetterStore>): Promise<void> {
