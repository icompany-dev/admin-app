...
export class ChangeBankSignatoryApplicationController extends ApplicationController<CompanyChangeBankSignatory> {
  ...
  constructor(props: IPropsApplication, emitEvents: any | null) {
    super(
      ...
      CompanyConstants.TARGET_CHANGE_BANK_SIGNATORY,
      emitEvents,
      props.applicationId
    )
  ...
  onApplicationDetailsClicked(): void {
    ...
    this.emitEvents("documentSelected", DocumentTargets.TARGET_CHANGE_BANK_SIGNATORY_RESOLUTIONS)
  }
  ...
  get bankName(): string {
    return this.application.value?.companyBank.bank.name ?? "-"
  }
  ...
  get branchName(): string {
    return this.application.value?.companyBank.bankBranch.name ?? "-"
  }

  get branchAddress(): string {
    return this.application.value?.companyBank.bankBranch.address ?? "-"
  }
