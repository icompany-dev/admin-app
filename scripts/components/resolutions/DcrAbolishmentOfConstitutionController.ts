...
export class DcrAbolishmentOfConstitutionController extends ResolutionController<CompanyAmendmentConstitution> {
  ...
  private documentTemplateId: string = "7196046c-222c-4d5a-a011-f9e8d7965070"
