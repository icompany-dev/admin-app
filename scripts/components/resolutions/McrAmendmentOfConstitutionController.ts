...
export class McrAmendmentOfConstitutionController extends ResolutionController<CompanyAmendmentConstitution> {
  ...
  private documentTemplateId: string = "1a57484a-b06b-413d-9a21-aca0ec9ca003"
