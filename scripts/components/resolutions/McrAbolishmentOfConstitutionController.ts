...
export class McrAbolishmentOfConstitutionController extends ResolutionController<CompanyAmendmentConstitution> {
  ...
  private documentTemplateId: string = "1217f10b-3aa2-43d7-bbea-aba6b6e3fe39"
  ...
  async setApplication(): Promise<void> {
    ...
    if (!this.companyRepository.error) {
      ...
      this.application.value.type = ConstitutionAmendmentTypes.Abolish
      this.initializeData()
    }
  }
