...
export class DcrAppointmentOfJointCompanySecretaryController {
  ...
  get resolutionTitle(): string {
    ...
    return `EXTRACT OF THE DIRECTORS’ RESOLUTION IN WRITING PURSUANT TO PARAGRAPH 15 OF THE THIRD SCHEDULE OF THE COMPANIES ACT 2016 PASSED ON 8 AUGUST 2026`
  }
