...
export class AllianceBankDocumentsController extends BankDocumentsController {
  bankId: string = BankConstants.ALLIANCE_BANK_DETAIL.id
  ...
  override get documentsToDisplay(): string[] {
    ...
    let documents = [
      "https://icompany-public.s3.ap-southeast-1.amazonaws.com/public/documents/samples/Alliance-BankUniversal-Business-Banking-Form.pdf",
