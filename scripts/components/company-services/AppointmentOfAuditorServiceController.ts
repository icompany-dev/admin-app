...
export class AppointmentOfAuditorServiceController extends CompanyServiceController<CompanyAuditorAppointment> {
  ...
  override setActionTrayElements(): void {
    ...
    this.actionTrayElements.value = [
      ...
      new ActionTrayElement("2", () => {}, {
        label: new ActionTrayLabel("More Information", "Maklumat Lanjut"),
      }),
    ]
  ...
  onBackToPageButtonClicked(): void {
    ...
    router.push(`/sdnbhd/${this.companyId}/financial-statements`)
  }
  ...
  get serviceWrapperProps() {
    ...
    return new PropsCompanyServiceWrapper(
      ...
      "DCR",
      false, //Pasca will be handled by financial statement PASCA
      this.hasPaid(),
      this.price.value,
      this.haveAllSigned(),
      this.hasSigned(),
